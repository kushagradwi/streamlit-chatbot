...
from api_helper import get_api_call_with_cookie
...
def fetch_dashboard_metrics(start_date: str, end_date: str):
    ...
    response = get_api_call_with_cookie(url, headers=headers)
    ...
    data = {
        ...
        "response_time": metrics["performance_metrics"]["avg_response_time_sec"],
        ...
        "unique_users": metrics["usage_metrics"]["uniques_users"],
        "chats_per_user": metrics["usage_metrics"]["chats_per_user"],
        "queries_per_user": metrics["usage_metrics"]["queries_per_user"],

        # Cost Metrics
        "input_tokens": metrics["cost_metrics"]["total_prompt_tokens"],
        "output_tokens": metrics["cost_metrics"]["total_completion_tokens"],
        "llm_cost": metrics["cost_metrics"]["total_llm_cost"],
        "embedding_cost": metrics["cost_metrics"]["total_embedding_cost"],
        "total_usage_cost": metrics["cost_metrics"]["total_llm_embed_cost"],
