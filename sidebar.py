    ...
    with st.sidebar:
        ...
        <div class="vy-sidebar-menu"> 
            <div class="vy-sidebar-list"> 
                <a class="vy-sidebar-link {'active' if active == 'app' else ''}" href="/app" target="_self">
            ...
            <div class="vy-sidebar-list"> 
                <a class="vy-sidebar-link {'active' if active == 'dashboard' else ''}" href="/dashboard" target="_self">
